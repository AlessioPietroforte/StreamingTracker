...
import it.example.applicazioneufficiale.charts.slider.BannerMoviesPagerAdapter;
import it.example.applicazioneufficiale.charts.slider.SliderThings;
...
public class ChartsActivity extends AppCompatActivity {
    ...
    private void setSlider() {
        ...
        bannerMoviesList.add(new SliderThings(2, "test2", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-4bt8gIQMLTRUQavXAyncTYp7p6UQhN3Ldg&usqp=CAU"));
        bannerMoviesList.add(new SliderThings(3, "test3", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-4bt8gIQMLTRUQavXAyncTYp7p6UQhN3Ldg&usqp=CAU"));
        bannerMoviesList.add(new SliderThings(4, "test4", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-4bt8gIQMLTRUQavXAyncTYp7p6UQhN3Ldg&usqp=CAU"));
